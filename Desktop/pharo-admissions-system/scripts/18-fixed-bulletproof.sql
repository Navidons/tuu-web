-- BULLETPROOF DATABASE FIX - CORRECTED SYNTAX
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE NOTICE 'ERROR adding application_id column: %', SQLERRM;
END $$;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding guardian_name: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding guardian_phone: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding guardian_email: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding medical_info: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding enrollment_date: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding emergency_contact: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding emergency_phone: %', SQLERRM;
    END;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding priority_score: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding interview_scheduled: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding interview_date: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding interview_notes: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding documents_verified: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding application_source: %', SQLERRM;
    END;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error creating application_comments table: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error creating application_analytics table: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error creating email_queue table: %', SQLERRM;
    END;
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'students' AND column_name = 'application_id') THEN
        ...
        END;
    ELSE
        RAISE NOTICE 'WARNING: application_id column still does not exist in students table';
    END IF;
END $$;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding foreign key for application_comments: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding foreign key for application_analytics: %', SQLERRM;
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error adding foreign key for email_queue: %', SQLERRM;
    END;
...
BEGIN
    ...
    BEGIN
        ...
        RAISE NOTICE 'RLS enabled for application_comments';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error enabling RLS for application_comments: %', SQLERRM;
    END;
    
    BEGIN
        ALTER TABLE application_analytics ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'RLS enabled for application_analytics';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error enabling RLS for application_analytics: %', SQLERRM;
    END;
    
    BEGIN
        ALTER TABLE email_queue ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE 'RLS enabled for email_queue';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Error enabling RLS for email_queue: %', SQLERRM;
    END;
