...
import { ArrowLeft, Upload, Plus, Trash2, X, MapPin, DollarSign, Users, Calendar, Star, Mountain, Clock, Camera, FileText, List, Route, Info, Image as ImageIcon, Download, Save } from "lucide-react"
...
export default function NewTour() {
  ...
  const [itineraryDays, setItineraryDays] = useState<ItineraryDay[]>([
    ...
    { day: 2, title: "", description: "", location: "", activities: "", accommodation: "", meals: "" },
    { day: 3, title: "", description: "", location: "", activities: "", accommodation: "", meals: "" }
  ])
  ...
  const loadCategories = async () => {
    try {
      ...
      if (data.success) {
        ...
        // Fallback categories
        setCategories([
          { id: 1, name: "Gorilla Trekking", slug: "gorilla-trekking", tourCount: 0 },
          { id: 2, name: "Wildlife Safari", slug: "wildlife-safari", tourCount: 0 },
          { id: 3, name: "Cultural Tours", slug: "cultural-tours", tourCount: 0 },
          { id: 4, name: "Adventure Sports", slug: "adventure-sports", tourCount: 0 },
          { id: 5, name: "Birdwatching", slug: "birdwatching", tourCount: 0 }
        ])
      }
    } catch (error) {
  ...
  const loadDraft = () => {
    ...
    try {
      ...
      if (savedDraft) {
        ...
        setHighlights(draftData.highlights || highlights)
        setInclusions(draftData.inclusions || inclusions)
        setExclusions(draftData.exclusions || exclusions)
        setItineraryDays(draftData.itineraryDays || itineraryDays)
        setBestTimeItems(draftData.bestTimeItems || bestTimeItems)
        setWhatToBringItems(draftData.whatToBringItems || whatToBringItems)
        setPhysicalRequirementItems(draftData.physicalRequirementItems || physicalRequirementItems)
        setImagePreviews(draftData.selectedImages || [])
        setFeaturedImagePreview(draftData.featuredImagePreview || "")
  ...
  }, [formData, highlights, inclusions, exclusions, itineraryDays, bestTimeItems, whatToBringItems, physicalRequirementItems])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add creator ID (null for admin mode)
      submitData.append('createdBy', '')
        ...
        <div className="container-max max-w-6xl">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-earth-900">Create New Tour</h1>
              <p className="text-earth-600">Add a comprehensive tour package</p>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <Tabs value={currentTab} onValueChange={setCurrentTab} className="space-y-8">
              ...
              <div className="flex flex-col gap-4 pt-6 border-t">
                ...
                {typeof window !== 'undefined' && localStorage.getItem('tour-draft') && (
